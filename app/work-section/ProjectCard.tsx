...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className={`relative z-10 h-[550px]  w-full items-stretch justify-center overflow-hidden rounded-3xl bg-center py-0 sm:h-[700px] sm:w-[100%] md:h-[650px] md:w-[100%] lg:h-[550px]`}
      initial="initial"
      animate="animate"
    >
      <Image
      ...
      >
        ...
        <AnimatedBody
          text={description}
          className={
            "mt-4 w-[90%] max-w-[500px] text-[16px] font-semibold text-[#95979D] "
          }
        />
